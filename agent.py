...
#                 {
#     "role": "user",
#     "content": f"""Write a YouTube Shorts script about a random fascinating space topic.
                
#                 IMPORTANT: Pick ONE random topic from this list every time:
...
#                 - Jupiter's Great Red Spot storm bigger than Earth
#                 - Saturn's rings made of billions of ice chunks
#                 - Titan — Saturn's moon with lakes of liquid methane
#                 - Europa's ocean hidden under miles of ice
#                 - Io — the most volcanically active world in the solar system
#                 - Uranus rotates on its side
#                 - Neptune's wind speeds of 1,500 mph
#                 - Pluto's heart-shaped nitrogen glacier
#                 - Mercury's ice at its poles despite being closest to the Sun
                
#                 GALAXIES & DEEP SPACE:
#                 - The Milky Way is on a collision course with Andromeda
#                 - Supermassive black holes at the center of every galaxy
#                 - Galaxies moving away from us faster than light
#                 - The Great Attractor pulling everything including us
#                 - Void regions of space completely empty for billions of light years
#                 - The cosmic web connecting all galaxies
#                 - Quasars brighter than a trillion suns
#                 - The oldest light we can see — 13.8 billion years old
#                 - Dark matter making up 27% of the universe
#                 - Dark energy causing the universe to expand faster
                
#                 SPACE PHYSICS & MIND-BENDING FACTS:
...
#                 - The observable universe is only a fraction of the real universe
...
#                 - Entropy — the universe is heading toward heat death
...
#                 - The ISS traveling at 17,500 mph orbiting Earth 16 times daily
#                 - SpaceX Starship — the biggest rocket ever built
#                 - The Mars rovers discovering ancient riverbeds
#                 - Hubble's Deep Field photo — 10,000 galaxies in one image
#                 - The New Horizons mission revealing Pluto up close
...
#                 - Extremophiles on Earth that could survive in space
#                 - Phosphine detected on Venus hinting at life
...
#     print("🎙️ Generating voiceover + subtitles...")
#     full_text = f"{script['hook']} {script['facts']} {script['cta']}"

#     async def create_audio():
#         communicate = edge_tts.Communicate(full_text, voice="en-US-GuyNeural")
#         # Save both audio AND subtitle file
#         await communicate.save("voiceover.mp3")
        
#         # Generate subtitles separately
#         communicate2 = edge_tts.Communicate(full_text, voice="en-US-GuyNeural")
#         with open("subtitles.vtt", "w", encoding="utf-8") as f:
#             async for chunk in communicate2.stream():
#                 if chunk["type"] == "WordBoundary":
#                     pass
        
#         # Generate proper subtitle file
#         communicate3 = edge_tts.Communicate(full_text, voice="en-US-GuyNeural")
#         await communicate3.save("voiceover2.mp3")
#         submaker = edge_tts.SubMaker()
#         async for chunk in edge_tts.Communicate(full_text, voice="en-US-GuyNeural").stream():
#             if chunk["type"] == "WordBoundary":
#                 submaker.feed(chunk)
#         with open("subtitles.vtt", "w", encoding="utf-8") as f:
...
#     print("✅ Video with text saved as output.mp4!")
